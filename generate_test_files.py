...
def generate_assemblies_test():
    ...
    assemblies = [
        ['Manual Screw Assembly', 'Manual', 'Standard screws and fixtures', 12.50, 3.50, 5.00, 10.0, 2.5],
        ['Ultrasonic Welding', 'Automated', 'High precision welding required', 25.00, 5.00, 8.00, 15.0, 3.0],
        ['Pad Printing', 'Semi-Auto', 'Company logo printing', 8.75, 2.25, 3.50, 12.0, 2.0],
    ]
    ...
    print("✓ Generated test_assemblies.xlsx (3 assemblies with fixed inspection cost)")
...
def generate_transport_test():
    ...
    # Add 2 sample transports (in feet)
    transports = [
        [12, 8, 6, 6500.00, 120],    # Standard truck: 12ft x 8ft x 6ft
        [14, 9, 7, 8500.00, 200],    # Large truck: 14ft x 9ft x 7ft
    ]
    ...
    print("✓ Generated test_transport.xlsx (2 transport options in feet)")
...
def generate_complete_quote_test():
    ...
    quote_data = [
        ...
        'SAP-TEST-001',
        'PART-ABC-123',
        'Widget Assembly Type A',
        'Rev-A',
        'Complete test quote with all components',
        5000,
        250.00,
        18.0,
    ...
    assemblies = [
        ['Manual Screw Assembly', 'Manual', 'Standard assembly process', 12.50, 3.50, 5.00, 10.0, 2.5],
    ]
...
def generate_multiple_quotes_test():
    ...
    instructions = [
        ...
        "- 1 packaging",
        "- 1 transport (dimensions in feet)",
        "",
    ...
    for row_num, instruction in enumerate(instructions, 1):
        ...
        elif instruction.startswith("IMPORTANT"):
    ...
    assemblies = [
        ['Auto Dashboard 2024', 'Insert Molding + Ultrasonic Welding', 'Automated', 'High precision required', 28.50, 6.50, 10.00, 12.0, 3.0],
        ['Electronics Housing Pro', 'Snap Fit Assembly', 'Manual', 'IP67 sealing required', 15.75, 4.25, 6.50, 10.0, 2.5],
        ['Medical Device Shell', 'Cleanroom Assembly + Sterilization', 'Manual', 'FDA Class II requirements', 45.00, 12.00, 15.00, 15.0, 1.5],
    ]
    ...
    transports = [
        ['Auto Dashboard 2024', 14, 9, 7, 9500.00, 240],
        ['Electronics Housing Pro', 12, 8, 6, 7200.00, 300],
        ['Medical Device Shell', 10, 7, 5, 5500.00, 100],
    ]
...
def main():
    ...
    print("  5. test_transport.xlsx - 2 transport options (in feet)")
